...
<div style="margin-left: auto; margin-right: auto; width:<?=$ciGbWidth?>px; ">

	<?php //********** Header *************?>
	<table border="0">
		<tr>
			<td class="title"><?PHP echo($TXT["Title"]); ?> <?PHP if ($admin) { ?>&nbsp;<a href="gb.php">Admin</a><?PHP } ?></td>
		</tr>
		<? if ($ErrorText!="") {?>
			<tr><td class="navi" ><?=$ErrorText?></td></tr>
		<?}?>
		<tr>
			<td class="navi" ><?PHP echo($TXT["EntryCountBegin"].getNumberOfEntrys().$TXT["EntryCountEnd"]);?></td>
		</tr>
	</table>
	
	<?php //********** New Entry *************?>
	<table cellspacing="0" cellpadding="2" width='<?=$ciGbWidth?>' >
	...
	<?php //***************Entrys***************** ?>
	<table width="<?=$ciGbWidth?>" cellspacing="0" cellpadding="2">
	<?php 
