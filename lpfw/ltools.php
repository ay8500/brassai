...
function searchSpecialChars($text) {
    $trans = array (
        " "=>".{1,2}",
        "a"=>".{1,2}","â"=>".{1,2}","ä"=>".{1,2}","â"=>".{1,2}","á"=>".{1,2}","à"=>".{1,2}",
        "e"=>".{1,2}","é"=>".{1,2}","è"=>".{1,2}",
        "i"=>".{1,2}","í"=>".{1,2}","ì"=>".{1,2}","Í"=>".{1,2}","Ì"=>".{1,2}",
        "o"=>".{1,2}","ó"=>".{1,2}","ò"=>".{1,2}","ö"=>".{1,2}",".{1,2}"=>".{1,2}","õ"=>".{1,2}",
        "u"=>".{1,2}","ú"=>".{1,2}","ù"=>".{1,2}","ü"=>".{1,2}","ű"=>".{1,2}",
        "A"=>".{1,2}","Á"=>".{1,2}","À"=>".{1,2}","Ä"=>".{1,2}","Å"=>".{1,2}","Â"=>".{1,2}",
        "E"=>".{1,2}","É"=>".{1,2}","È"=>".{1,2}",
        "O"=>".{1,2}","Ó"=>".{1,2}","Ò"=>".{1,2}","Ö"=>".{1,2}","Ő"=>".{1,2}",
        "U"=>".{1,2}","Ú"=>".{1,2}","Ù"=>".{1,2}","Ü"=>".{1,2}","Ű"=>".{1,2}",
        "ș"=>".{1,2}","Ș"=>".{1,2}","Ț"=>".{1,2}","ț"=>".{1,2}"
    );
